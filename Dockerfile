...
COPY --from=goreleaser/goreleaser:v2.15.0@sha256:85ea9f2626e94bde152b6c47bf3398e0a711a4e4a254c71d2f9b5bc5881448f9 /usr/bin/goreleaser /usr/local/bin/goreleaser
